...
class Pokemon(models.Model):
    ...
    photo = models.ImageField(null=True, blank=True, verbose_name="изображение покемона", upload_to = "../media/img")
...
class PokemonEntity(models.Model):
    ...
    appeared_at = models.DateTimeField(null=True, blank=True, verbose_name="время и дата появления покемона")
    disappeared_at = models.DateTimeField(null=True, blank=True, verbose_name="время и дата исчезновения покемона")
